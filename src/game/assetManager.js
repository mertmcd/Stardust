...
// import logoSrc from "../../assets/core/game_logo.png";
...
assetManager.loadAssets = function (main, callback) {
    ...
    // image, atlas, spritesheet

    // png formatında bir çok küçük görsel varsa (özellikle butonlar, oklar, semboller..) atlasa dönüştürülecek
...
function prepareAnims() {
    ...
    // dude - 3 farklı animasyon
    // girl - 5 farklı animasyon
